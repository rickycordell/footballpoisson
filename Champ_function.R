...
champ_model <- function(home_team, away_team, book_home,
                           book_away,book_draw, book_btts, book_over2.5)
  
{
  #Retrieves required information from the championship stats data frame
  ...
  cat("\nThe Value in betting on",home_team,"is:", home_wager_amount)
  cat("\nThe Value in betting on",away_team,"is:", away_wager_amount)
  cat("\nThe Value in betting on the draw is:", draw_wager_amount)
  cat("\nThe Value in betting on over 2.5 goals is:", over2.5_wager_amount)
  cat("\nThe Value in betting on both teams to score is", btts_wager_amount)
